;(function() {
    ...
    function rgba(t, e, n, r) {
        ...
        return {
            ...
            decimalToFloat: function(t) {
                var e = 0;
                return 255 <= t ? "1.000000" : t <= 0 ? "0.000000" : (e = t / 255,
    ...
    function correctSvgPathForKnot(t, e, n, r, a, i, u) {
        var o = e.parentElement.parentElement.parentElement.parentElement.parentElement.classList.contains("knot")
          , l = n.parentElement.parentElement.parentElement.parentElement.parentElement.classList.contains("knot");
        if (!o && l) {
        ...
        } else if (o && !l && n.parentElement.parentElement.parentElement.classList.contains("left-col") && r.left > a.left)
    ...
    function formatAxisValueForDisplay(t) {
        var e = "";
        return void 0 === t || "0" === (e = t.trim()) || "0.000000" === e ? "0.0" : ("." === (e = e.replace(/0+$/, "")).charAt(e.length - 1) && (e += "0"),
        e)
    }
    ...
    function createElems(t) {
        for (var e, n, r = [], a = 0, i = t.length, u = 0, o = null; a < i; ++a)
            if ((o = null) !== t[a]) {
                if (void 0 !== t[a].tag && (o = createElem(t[a].tag, t[a].classes || [], t[a].attrs || []),
                void 0 !== t[a].childs))
                    for (u = 0,
                    n = (e = createElems(t[a].childs)).length; u < n; ++u)
                        o.appendChild(e[u]);
    ...
    function convertTextToProps(t) {
        ...
        function extractItemsInParenthesis() {
            var t, e = [], n = [], r = 0, a = "", i = !1, u = 1;
            for (l += 1; l < o && ((i = '"' === s[l] && "\\" !== s[l - 1] ? !i : i) || "(" !== s[l] || (u += 1),
            i || ")" !== s[l] || 0 != --u); )
                !i && "," === s[l] && u <= 1 ? (n.push(a),
                a = "") : a += s[l],
                l += 1;
        ...
        for (; l < o; )
            if ('"' === s[l] && 0 === r.length)
                ...
                if (n.name && "" !== n.name)
                    return n.value = s.substring(n.name.length + 1),
                    n.isDirty = !0,
                    n;
                n.name = r,
                r = "",
                ...
                if (null !== (e = function() {
                    ...
                    if (void 0 !== n.value)
                        return n.name ? n.value = s.substring(n.name.length + 1) : n.value = s,
                        n.isDirty = !0,
                        n;
                    n.value = extractItemsInParenthesis(),
                    l += 1
                }
            else
                r += s[l],
                l += 1;
        return "" !== r && (-1 === ["NSLOCTEXT", "LOCGEN_FORMAT_NAMED", "INVTEXT"].indexOf(r) ? n.value = r : n.prefix = r),
        n
    }
    ...
    function formatTextL11nFromProp(t) {
        ...
        r = formatTextL11nFromProp(t.value[0]); n < e; n += 2)
    ...
    Bus.prototype.listen = function(t, e) {
        return "string" != typeof t ? new TypeError("Argument 'eventName' is incorrect, expect string, get " + typeof t) : "function" != typeof e ? new TypeError("Argument 'callback' is incorrect, expect function, get " + typeof e) : (void 0 === this.data[t] && (this.data[t] = []),
    ...
    Bus.prototype.emit = function(t, e) {
        ...
        for (r = this.data[t].length,
        n = 0; n < r; ++n)
            if (!1 === this.data[t][n].apply(null, e))
                return !1;
        return !0
    }
    ;
    function flattenHierarchy(e, n) {
        for (var t, i = [], s = 0, o = e.length, r = [], d = 0; s < o; ++s) {
            if (!0 === e[s].containsVisualNodes && void 0 !== e[s].nodes)
                for (r = [],
                d = 0,
                t = (r = null !== searchPropWithName(e[s].nodes[0].props, "GraphGuid") && 0 < e[s].nodes[0].nodes.length ? flattenHierarchy(e[s].nodes[0].nodes, e[s].guid) : flattenHierarchy(e[s].nodes, e[s].guid)).length; d < t; ++d)
                    i.push(r[d]);
            i.push({
                node: e[s],
                parentGUID: n
    ...
    function eventPasteTextFromClipboard(e) {
        ...
        if (0 === e.length)
            ...
            for (t = flattenHierarchy(e, null),
            d = this.blueprint.nodesParsed.length,
            o = 0,
            n = t.length; o < n; ++o)
            ...
            this.listIDs(),
            setTimeout(function() {
                for (this.instances.environment.updateLoading("DISPLAY NODES..."),
                this.instances.environment.showLoading(),
                a = [],
                i = this.blueprint.nodesDisplayed.nodes.length; l < i; ++l)
    ...
    function eventReduceNode(e) {
        for (var n = [], t = 0, i = this.findNodeIdxWithId(e), s = searchPropWithName(this.blueprint.nodesParsed[i].node.objectDefinition, "Name"), o = this.blueprint.nodesParsed[i].node.pins.length; t < o; ++t)
            !1 === this.blueprint.nodesParsed[i].node.pins[t].hasToHidePin(!1) && n.push(s.value + " " + this.blueprint.nodesParsed[i].node.pins[t].id);
        this.bus.emit("interactor__reduce_node", [e, n])
    }
    function fixPositionByCheckingNodesInViewport(e, n, t) {
        for (var i, s = [], o = [[n[0], n[0] + t[0]], [n[1], n[1] + t[1]]], r = 0, d = e.length, a = [], l = 0; r < d; ++r)
    ...
    function findMinPosNode() {
        ...
        for (a = [[r = this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[0].idx].node.position[0], d = this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[0].idx].node.position[1]]],
        l = [r, d],
        e = this.blueprint.nodesDisplayed.nodes.length; p < e; ++p)
            ...
            a.push([n, t]),
            (l[0] > n || l[0] === n && l[1] > t) && (l = [n, t]),
            r = Math.min(n, r),
            d = Math.min(t, d);
        return r === l[0] && d === l[1] ? {
            x: -(r + s),
            y: -(d + o)
        } : (null === (h = fixPositionByCheckingNodesInViewport(a, [r, d], [(i = this.data.htmlElement.querySelector(".frame").getBoundingClientRect()).width, i.height])) ? h = [-(l[0] + s), -(l[1] + o)] : (h[0] = -(h[0] + s),
        h[1] = -(h[1] + o)),
        {
            x: h[0],
            y: h[1]
    ...
    function eventDblclick(e) {
        var n, t, i, s, o = [], r = !1, d = 0, a = this.blueprint.nodesParsed.length, l = 0, p = null, h = 0, u = null, c = 0;
        if ("string" == typeof e) {
            for (; d < a; ++d)
        ...
        setTimeout(function() {
            ...
            this.instances.environment.drawLinks(this.blueprint.nodesDisplayed.links),
            setTimeout(function() {
                for (this.instances.interactor.moveCanvasTo(findMinPosNode.call(this)),
                p = this.data.htmlElement.querySelector(".frame-header__breadcrumb").children,
                h = p.length - 1; 0 < h; --h)
                    p[h].remove();
                if (null !== e) {
                    for (t = extractBreadcrumb.call(this, e, []),
    ...
    function getRenderHTMLAndSize(e) {
        for (var n, t, i, s = e.childNodes, o = s.length, r = 0, d = null, a = "", l = null, p = [], h = document.createDocumentFragment(), u = [], c = 0, b = 0, m = 0, g = 0, f = 0, y = 0, v = ""; r < o; ++r)
            ...
            -1 !== (n = (a = s[r].style.transform).indexOf("translate(")) && -1 !== (t = a.indexOf(")", n + 10)) && (p = a.substring(n + 10, t).split(","),
            l.x = p[0].replace("px", "") >> 0,
            1 < p.length && (l.y = p[1].replace("px", "") >> 0)),
            u.push(l),
            h.append(s[r].cloneNode(!0)),
            g = 0 === r ? (c = l.x,
            b = l.y,
            m = l.x + d.width,
            l.y + d.height) : (c = Math.min(c, l.x),
            b = Math.min(b, l.y),
            m = Math.max(m, l.x + d.width),
            Math.max(g, l.y + d.height));
        for (0 < c ? f = -c : c < 0 && (f = Math.abs(c)),
        0 < b ? y = -b : b < 0 && (y = Math.abs(b)),
        e = m + f + 20,
        i = g + y + 20,
        o = (s = h.childNodes).length,
        r = 0; r < o; ++r)
    ...
    function downloadBlueprintAsImage(e, n, t, i) {
        var e = "data:image/svg+xml;utf8," + window.encodeURIComponent("<svg xmlns='http://www.w3.org/2000/svg' width='" + n + "' height='" + t + "'><foreignObject x='0' y='0' width='" + n + "' height='" + t + "'>" + e + "</foreignObject></svg>")
          , s = new Image
    ...
    function eventGenerateImage(e) {
        var n = getRenderCssAsString()
          , t = getRenderHTMLAndSize(this.data.htmlElement.querySelector(".canvas"))
          , i = document.createElement("div");
        i.innerHTML = n + t.html,
    ...
    function Editor(e, n, t, i) {
        ...
        this.bus.listen("copy_nodes_to_clipboard", this.eventsBinding.copyNodesToClipboard),
        this.bus.listen("paste_text_from_clipboard", this.eventsBinding.pasteTextFromClipboard),
        this.bus.listen("dblclick", this.eventsBinding.dblclick),
        this.callbackInitialization = null,
        void (this.error = null)) : new TypeError("Argument 'bus' is incorrect, expect Bus, get " + typeof i) : new TypeError("Argument 'htmlElement' is incorrect, expect HTMLElement, get " + typeof n)
    }
    ...
    Editor.prototype.addLinksForBelow413 = function() {
        for (var e, n, t, i = 0, s = this.blueprint.nodesDisplayed.nodes.length, o = 0, r = [], d = "", a = [], l = [], p = 0, h = 0, u = "", c = "", b = [], m = null, g = [], f = null; i < s; ++i)
            for (o = 0,
            e = this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[i].idx].node.pins.length; o < e; ++o)
                if (!1 !== this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[i].idx].node.pins[o].isLinkedTo() && !this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[i].idx].node.pins[o].isInput() && null !== (n = searchPropWithName(this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[i].idx].node.objectDefinition, "Name"))) {
                    for (m = n.value + " " + this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[i].idx].node.pins[o].id,
                    r = [],
                    d = "",
                    p = 0,
                    h = (l = this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[i].idx].node.pins[o].getLinks()).length; p < h; ++p)
                    ...
                    h = r.length; p < h; ++p)
                        u = m + "," + r[p],
                        c = r[p] + "," + m,
                        -1 === b.indexOf(u) && -1 === b.indexOf(c) && (b.push(m + "," + r[p]),
                        0 === u.indexOf("AnimStateTransitionNode") ? (g[t = m.split(" ")[0]] || (g[t] = []),
                        g[t].push(r[p])) : 0 === c.indexOf("AnimStateTransitionNode") && (g[t = r[p].split(" ")[0]] || (g[t] = []),
                        g[t].push(m)))
                }
        for (f in g)
    ...
    Editor.prototype.addLinks = function() {
        for (var e, n, t, i, s = 0, o = this.blueprint.nodesDisplayed.nodes.length, r = 0, d = [], a = 0, l = "", p = "", h = [], u = null, c = [], b = null; s < o; ++s)
            for (r = 0,
            e = this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[s].idx].node.pins.length; r < e; ++r)
                if (!1 !== this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[s].idx].node.pins[r].isLinkedTo() && !this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[s].idx].node.pins[r].isInput() && null !== (n = searchPropWithName(this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[s].idx].node.objectDefinition, "Name")))
                    for (u = n.value + " " + this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[s].idx].node.pins[r].id,
                    a = 0,
                    t = (d = this.blueprint.nodesParsed[this.blueprint.nodesDisplayed.nodes[s].idx].node.pins[r].getLinks()).length; a < t; ++a)
                        l = u + "," + d[a],
                        p = d[a] + "," + u,
                        -1 === h.indexOf(l) && -1 === h.indexOf(p) && (h.push(u + "," + d[a]),
                        0 === l.indexOf("AnimStateTransitionNode") ? (c[i = u.split(" ")[0]] || (c[i] = []),
                        c[i].push(d[a])) : 0 === p.indexOf("AnimStateTransitionNode") && (c[i = d[a].split(" ")[0]] || (c[i] = []),
                        c[i].push(u)));
        for (b in c)
    ...
    Editor.prototype.initEnvironment = function() {
        ...
        this.instances.environment.createPlayground(this.data.options.type) && (this.elapsedTime.createPlayground = performance.now() - t,
        n = findMinPosNode.call(this),
        this.data.htmlElement.querySelector(".canvas").style.transform = getStyleTransformCSS(n.x, n.y, 1),
        this.data.htmlElement.querySelector(".reference").style.transform = getStyleTransformCSS(n.x, n.y, 1),
        setTimeout(function() {
            for (t = performance.now(),
            this.instances.environment.updateLoading("DISPLAY NODES..."),
            i = [],
            e = this.blueprint.nodesDisplayed.nodes.length; s < e; ++s)
    ...
    Editor.prototype.initUpdater = function() {
        ...
        this.instances.environment.showLoading()),
        null !== this.callbackInitialization && (this.callbackInitialization(e, this.error),
        this.callbackInitialization = null)
    }
    ,
    Editor.prototype.updateBlueprintText = function(e, n) {
        ...
        setTimeout(function() {
            for (i = performance.now(),
            this.instances.environment.updateLoading("DISPLAY NODES..."),
            this.instances.environment.showLoading(),
            s = [],
            t = this.blueprint.nodesDisplayed.nodes.length; o < t; ++o)
    ...
    function getPlatform() {
        return 0 === window.navigator.platform.toUpperCase().indexOf("MAC") ? PLATFORM_MAC : PLATFORM_WIN
    }
    function bestMultiple(t) {
        return (t = t / STEP) - (t = t >> 0) <= .5 ? t * STEP : (1 + t) * STEP
    }
    function getPositions(t) {
        var t = t.getBoundingClientRect()
          , e = t.top
          , s = t.left;
        return [[s, s + t.width], [e, e + t.height]]
    }
    ...
    function extractTranslateScale(t) {
        var e = {
          ...
          , o = t.indexOf("scale(");
        return -1 !== i && -1 !== (s = t.indexOf(")", i + 10)) && (n = t.substring(i + 10, s).split(","),
        e.x = n[0].replace("px", "") >> 0,
        1 < n.length && (e.y = n[1].replace("px", "") >> 0)),
        -1 !== o && -1 !== (s = t.indexOf(")", o + 6)) && (e.scale = parseFloat(t.substring(o + 6, s)),
    ...
    Interactor.prototype.startAllBinding = function() {
        var t, e = 0;
        for (this.dom.frame = this.dom.root.querySelector(".frame"),
        ...
        this.dom.panelBtns = this.dom.root.querySelectorAll(".panel .panel__button"),
        this.dom.zoom = this.dom.root.querySelector(".frame-header__current-zoom"),
        this.dom.overlay = this.dom.root.querySelector(".overlay"),
        this.dom.breadcrumb = this.dom.root.querySelector(".frame-header__breadcrumb"),
        window.addEventListener("mousedown", this.eventsBinding.focusPlayground),
        window.addEventListener("touchstart", this.eventsBinding.focusPlayground),
        this.dom.layer.addEventListener("mousedown", this.eventsBinding.pointerDown),
        this.dom.layer.addEventListener("touchstart", this.eventsBinding.pointerDown, {
            passive: !1
        }),
        ...
        this.dom.layer.addEventListener("wheel", this.eventsBinding.pointerWheel),
        this.dom.layer.addEventListener("dblclick", this.eventsBinding.pointerDoubleClick),
        document.addEventListener("copy", this.eventsBinding.copyNodes),
        document.addEventListener("paste", this.eventsBinding.pasteNodes),
        this.dom.btns.addEventListener("click", this.eventsBinding.headerButtons),
        document.addEventListener("webkitfullscreenchange", this.eventsBinding.exitFullscreenHandlerForResizing),
        document.addEventListener("fullscreenchange", this.eventsBinding.exitFullscreenHandlerForResizing),
        this.dom.breadcrumb.addEventListener("click", this.eventsBinding.breadcrumb),
        t = this.dom.panelBtns.length; e < t; ++e)
    ...
    Interactor.prototype.eventFocusPlayground = function(t) {
        for (var e = 0, s = t.composedPath(), n = s.length; e < n; ++e)
            if (s[e] === this.dom.root)
                return void (this.states.inPlayground = !0);
        this.states.inPlayground = !1
    }
    ,
    Interactor.prototype.eventPointerDown = function(t) {
        var e;
        return null === this.states.current && (this.states.current = STATE_DOWN,
        window.TouchEvent && t instanceof TouchEvent ? (this.states.inFullscreen ? (this.states.isTouch = !0,
        this.events.pointerDown = t.touches[0],
        this.startMovingCanvas(this.events.pointerDown)) : 1 === t.touches.length && (this.states.isTouch = !0,
        this.events.pointerDown = t.touches[0],
        this.states.timeoutLongpress = window.setTimeout(this.eventsBinding.pointerLongpress, 150),
        this.startMovingCanvas(this.events.pointerDown)),
        !0) : ((this.events.pointerDown = t).button === LEFT_MOUSE ? this.states.isLeftClick = !0 : t.button === RIGHT_MOUSE && (this.states.isRightClick = !0),
        this.states.platform === PLATFORM_MAC && !0 === t.ctrlKey && (this.states.isRightClick = !0),
        this.states.isRightClick || this.states.isTouch ? void this.startMovingCanvas(this.events.pointerDown) : this.states.mode === MODE_WRITE && null !== (e = parents(t.target, ["pin"], 5)) ? !0 === t.ctrlKey || !0 === t.altKey ? void 0 : void this.drawNewLink(e, this.events.pointerDown) : null !== (e = parents(t.target, ["node"], 5)) ? !1 === this.events.pointerDown.target.classList.contains("less") && !1 === this.events.pointerDown.target.classList.contains("more") && null === parents(this.events.pointerDown.target, ["less"], 0) && null === parents(this.events.pointerDown.target, ["more"], 0) && !1 === t.target.classList.contains("fake-input") && !1 === t.target.classList.contains("checkbox") && "SELECT" !== t.target.tagName ? (this.states.isMovingNode = !0,
    ...
    Interactor.prototype.eventPointerMove = function(t) {
        if (this.states.current !== STATE_MOVE && this.states.current !== STATE_DOWN)
            return !1;
        if (this.states.previous = this.states.current,
        this.states.current = STATE_MOVE,
        window.TouchEvent && t instanceof TouchEvent) {
            if (this.events.pointerMove = t.touches[0],
        ...
        if (this.states.isRightClick || this.states.isTouch)
            return this.lastUpdateCalled && cancelAnimationFrame(this.lastUpdateCalled),
            void (this.lastUpdateCalled = requestAnimationFrame(this.eventsBinding.doMoveCanvas));
    ...
    Interactor.prototype.eventPointerUp = function(t) {
        ...
        if (this.states.current !== STATE_MOVE && this.states.current !== STATE_DOWN)
            return !1;
        if (e = this.states.previous,
        s = this.states.current,
        this.states.previous = this.states.current,
        this.states.current = STATE_UP,
        window.TouchEvent && t instanceof TouchEvent)
            return 0 < t.touches.length ? (this.states.previous = e,
            void (this.states.current = s)) : (this.events.pointerUp = t.touches[0],
        ...
        if (this.events.pointerUp = t,
        this.events.pointerDown.target === this.dom.canvas && this.states.previous === STATE_DOWN && this.unselectAllNodes(),
        ...
        !0 === this.events.pointerDown.target.classList.contains("less") || null !== parents(this.events.pointerDown.target, ["less"], 0) ? this.sendReduceNode(parents(this.events.pointerDown.target, ["node"], 5)) : !0 !== this.events.pointerDown.target.classList.contains("more") && null === parents(this.events.pointerDown.target, ["more"], 0) || this.sendExpandNode(parents(this.events.pointerDown.target, ["node"], 5)),
    ...
    Interactor.prototype.eventPointerWheel = function(t) {
        if (!1 === this.states.inFullscreen && !1 === t.ctrlKey)
            ...
            if (this.eventsBinding.hideOverlayForZoom(),
            t.preventDefault(),
            this.states.isRightClick || this.states.isLeftClick)
                return !1;
            if (t.deltaY < 100) {
                if (this.states.wheelAccumulator += t.deltaY,
    ...
    Interactor.prototype.eventPointerPinch = function(t) {
        var e = (t.touches[0].pageX - t.touches[1].pageX) * (t.touches[0].pageX - t.touches[1].pageX)
          , s = (t.touches[0].pageY - t.touches[1].pageY) * (t.touches[0].pageY - t.touches[1].pageY)
          , e = Math.sqrt(e + s);
        null === this.pinchDistance ? this.pinchDistance = e : (t.pageX = t.touches[0].pageX,
        t.pageY = t.touches[0].pageY,
        50 < (s = this.pinchDistance - e) ? (this.zoomOut(t),
        this.pinchDistance = e,
        this.diffX = t.touches[0].clientX - this.canvas.x,
        this.diffY = t.touches[0].clientY - this.canvas.y) : s < -50 && (this.zoomIn(t, !0),
        this.pinchDistance = e,
        this.diffX = t.touches[0].clientX - this.canvas.x,
    ...
    Interactor.prototype.eventExitFullscreenHandlerForResizing = function() {
        null !== document.fullscreenElement && null !== document.webkitFullscreenElement || (this.dom.frame.style.height = this.frameSize,
        this.dom.btns.querySelector(".frame-header__buttons-fullscreen").classList.remove("frame-header__buttons-fullscreen--exit"),
    ...
    Interactor.prototype.eventCopyNodes = function(t) {
        var e;
        !1 === this.states.inPlayground || t.target.classList.contains("fake-input") || 0 < (e = this.dom.root.querySelectorAll(".selected")).length && (this.copyNodesSelectedInClipboard(t, e),
        t.preventDefault())
    }
    ,
    Interactor.prototype.eventPasteNodes = function(t) {
        ...
        if (!1 !== this.states.inPlayground) {
            if (t.target.classList.contains("fake-input"))
                ...
                void ((s = window.getSelection()).getRangeAt && s.rangeCount && ((n = s.getRangeAt(0)).deleteContents(),
                e = document.createTextNode(t.clipboardData.getData("text/plain")),
                n.insertNode(e),
                n.setStartAfter(e),
                n.setEndAfter(e),
                s.removeAllRanges(),
            ...
            if (this.states.mode !== MODE_READ) {
                if (this.states.isTreatingPaste = !0,
    ...
    Interactor.prototype.eventHeaderButtons = function(t) {
        t.target.classList.contains("frame-header__buttons-fullscreen") ? this.fullscreenToggle() : t.target.classList.contains("frame-header__buttons-reset") ? (this.resetCanvas(),
        this.resetScale(),
        this.moveCanvasTo(this.resetPosition)) : t.target.classList.contains("frame-header__buttons-panel") && this.panelToggle()
    }
    ,
    Interactor.prototype.eventPanelButtons = function(t) {
        if ("generate-image" === t.target.getAttribute("data-feature-panel-name"))
            !0 !== this.states.isGeneratingImage && (this.states.isGeneratingImage = !0,
            this.dom.overlay.style.pointerEvents = "all",
            this.dom.overlay.style.display = "flex",
            this.dom.overlay.textContent = "Generating Image",
            this.bus.emit("editor__generate_image", [function() {
                this.dom.overlay.textContent = "",
                this.dom.overlay.style.display = "none",
                this.dom.overlay.style.pointerEvents = "none",
                this.states.isGeneratingImage = !1
            }
            .bind(this)]))
    }
    ,
    ...
    Interactor.prototype.expandNode = function(t) {
        ...
        this.bus.emit("re_draw_links", [t, function() {
    ...
    Interactor.prototype.moveCanvas = function(t) {
        ...
        this.canvas.x === e && this.canvas.y === t || (this.dom.canvas.style.transform = getStyleTransformCSS(e, t, this.scale),
        this.dom.reference.style.transform = getStyleTransformCSS(e, t, this.scale),
        this.canvas.x = e,
        this.canvas.y = t)
    }
    ,
    Interactor.prototype.startMovingNode = function(t, e) { return; /* CHANGED */
    ...
    Interactor.prototype.moveNode = function(t) {
        ...
        if (this.dom.nodeMoving.classList.contains("selected"))
            ...
            for (o = 0,
            r = (l = this.dom.canvas.querySelectorAll(".node.selected")).length; o < r; ++o)
                l[o].classList.remove("selected");
            this.dom.nodeMoving.classList.add("selected"),
            this.dom.nodesMoving = []
        }
        if ((h = extractTranslateScale(this.dom.nodeMoving.style.transform)).x !== a || h.y !== t)
            if (this.dom.nodeMoving.style.transform = "translate(" + a + "px," + t + "px)",
            1 < this.dom.nodesMoving.length) {
                for (e = a - h.x,
                s = t - h.y,
                o = 0,
                r = this.dom.nodesMoving.length; o < r; ++o)
                    this.dom.nodesMoving[o] !== this.dom.nodeMoving && (n = (h = extractTranslateScale(this.dom.nodesMoving[o].style.transform)).x + e,
                    i = h.y + s,
                    this.dom.nodesMoving[o].style.transform = "translate(" + n + "px," + i + "px)");
    ...
    Interactor.prototype.zoomIn = function(t, e) {
        ...
        this.currentZoom >= LIMIT_ZOOM_IN || 0 === this.currentZoom && !1 === t.ctrlKey && !1 === e || (this.currentZoom += 1,
    ...
    Interactor.prototype.zoomOut = function(t) {
        ...
        this.currentZoom <= LIMIT_ZOOM_OUT || (0 < this.scale - ZOOM_STEP && (this.scale = floatFixed(this.scale - ZOOM_STEP, 2),
        --this.currentZoom),
    ...
    Interactor.prototype.endLink = function(t) {
        t.target.classList.contains("clink") ? this.bus.emit("new_link", [this.startPinLink, t.target, this.scale]) : this.dom.root.querySelector("svg.moving").remove()
    }
    ,
    ...
    Interactor.prototype.drawMultiSelect = function(t) {
        var e, s, n = {}, i = {}, o = 0, r = 0, a = [], l = 0, h = !1;
        for (this.dom.canvas.style.transform = getStyleTransformCSS(this.canvas.x, this.canvas.y, 1),
        e = {
        ...
        0 === (o = Math.max(n.left, i.left) - Math.min(n.left, i.left)) && (o = 2),
        0 === (r = Math.max(n.top, i.top) - Math.min(n.top, i.top)) && (r = 2),
        null === this.dom.multiSelect && (this.dom.canvas.appendChild(createElem("div", ["multi-select"], [])),
        this.dom.multiSelect = this.dom.canvas.querySelector(".multi-select")),
        this.dom.multiSelect.style.left = t + "px",
        this.dom.multiSelect.style.top = e + "px",
        this.dom.multiSelect.style.width = o + "px",
        this.dom.multiSelect.style.height = r + "px",
        this.dom.multiSelect.style.borderImageWidth = (6 / this.scale >> 0) + "px",
        s = (a = this.dom.canvas.querySelectorAll(".node")).length; l < s; ++l)
            this.states.multiSelectHasShiftKey && -1 !== this.states.nodeIDsAlreadySelected.indexOf(a[l].getAttribute("data-id")) || (h = isOverlapping(this.dom.multiSelect, a[l]),
            (h = this.states.multiSelectHasCtrlKey && -1 !== this.states.nodeIDsAlreadySelected.indexOf(a[l].getAttribute("data-id")) ? !h : h) ? a[l].classList.add("selected") : a[l].classList.remove("selected"));
        this.dom.canvas.style.transform = getStyleTransformCSS(this.canvas.x, this.canvas.y, this.scale)
    }
    ,
    ...
    Interactor.prototype.setScale = function(t) {
        ...
        for (this.scale = t,
        this.currentZoom = 0,
        e = LIMIT_ZOOM_OUT; e <= LIMIT_ZOOM_IN; ++e) {
            if (s === t) {
                this.currentZoom = e;
                break
            }
    ...
    Interactor.prototype.fullscreenToggle = function() {
        ...
        document.fullscreenElement || document.webkitFullscreenElement ? (this.dom.frame.style.height = this.frameSize,
        this.dom.btns.querySelector(".frame-header__buttons-fullscreen").classList.remove("frame-header__buttons-fullscreen--exit"),
        this.states.inFullscreen = !1,
        document.exitFullscreen ? document.exitFullscreen() : document.webkitCancelFullScreen && document.webkitCancelFullScreen()) : t.requestFullscreen ? (t.requestFullscreen(),
        this.dom.frame.style.height = window.screen.height + "px",
        this.dom.btns.querySelector(".frame-header__buttons-fullscreen").classList.add("frame-header__buttons-fullscreen--exit"),
        this.states.inFullscreen = !0) : t.webkitRequestFullscreen && (t.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT),
        this.dom.frame.style.height = window.screen.height + "px",
        this.dom.btns.querySelector(".frame-header__buttons-fullscreen").classList.add("iframe-header__buttons-fullscreen--exit"),
    ...
    Interactor.prototype.stop = function() {
        var t, e = 0;
        if (window.removeEventListener("mousedown", this.eventsBinding.focusPlayground),
        window.removeEventListener("touchstart", this.eventsBinding.focusPlayground),
        this.dom.canvas && (this.dom.canvas.removeEventListener("mousedown", this.eventsBinding.pointerDown),
        this.dom.canvas.removeEventListener("touchstart", this.eventsBinding.pointerDown, {
            passive: !1
        })),
        window.removeEventListener("mousemove", this.eventsBinding.pointerMove),
        window.removeEventListener("touchmove", this.eventsBinding.pointerMove, {
            passive: !1
        }),
        ...
        this.dom.canvas && (this.dom.canvas.removeEventListener("wheel", this.eventsBinding.pointerWheel),
        this.dom.canvas.removeEventListener("dblclick", this.eventsBinding.pointerDoubleClick)),
        ...
        this.dom.btns && this.dom.btns.removeEventListener("click", this.eventsBinding.headerButtons),
        document.removeEventListener("webkitfullscreenchange", this.eventsBinding.exitFullscreenHandlerForResizing),
        document.removeEventListener("fullscreenchange", this.eventsBinding.exitFullscreenHandlerForResizing),
        this.dom.breadcrumb && this.dom.breadcrumb.removeEventListener("click", this.eventsBinding.breadcrumb),
        this.dom.panelBtns)
    ...
    Interpreter.prototype.detectUnrealVersion = function() {
        -1 === this.text.indexOf("CustomProperties Pin") && -1 === this.text.indexOf("ExportedNodes") && (this.isBelow413Version = !0),
    ...
    Interpreter.prototype.splitTextInCleanLines = function() {
        ...
        this.countLines = this.lines.length; e < this.countLines; ++e)
    ...
    Interpreter.prototype.parseLines = function() {
        for (var e, t = 0; t < this.countLines; ++t) {
            ...
            this.isNewNode(this.lines[t]) ? this.createNode(this.lines[t]) : this.isEndNode(this.lines[t]) ? (this.isBelow413Version && (this.currentNode.pins = this.reorderGraphPins()),
            this.changeNodeIfNecessary(),
            this.closeNode()) : this.treatLine(this.lines[t])
        }
    }
    ,
    ...
    Interpreter.prototype.isGraphPinDefinition = function(e) {
        if (!0 === /^Begin Object/i.test(e)) {
            if (-1 === e.indexOf("EdGraphPin"))
                return !1;
            if (e = this.extractGraphPinName(e),
            void 0 !== this.graphPins[e])
                return this.currentGraphPinName = e,
                !0
        }
        return !1
    }
    ...
    Interpreter.prototype.changeNodeIfNecessary = function() {
        ...
        if (this.isCustomNode())
            return !1;
        this.isConvNode() ? (e = new NConv,
        this.replaceNode(e)) : this.isKismetMathNode() ? (e = new NKismetMath,
        this.replaceNode(e)) : this.isDotNode() ? (e = new NDot,
        this.replaceNode(e)) : this.isArrayNode() && (e = new NArray,
        this.replaceNode(e))
    }
    ,
    ...
    Interpreter.prototype.nodeFactory = function(e) {
        for (var t = 0, r = EQUIVALENCE_MAP_BLUEPRINT_CLASS_TO_OBJECT.length, n = null; t < r; ++t)
            if (-1 !== e.indexOf(EQUIVALENCE_MAP_BLUEPRINT_CLASS_TO_OBJECT[t].blueprintClass)) {
                ...
                if ("K2Node_Composite" !== EQUIVALENCE_MAP_BLUEPRINT_CLASS_TO_OBJECT[t].blueprintClass || ((n = new EQUIVALENCE_MAP_BLUEPRINT_CLASS_TO_OBJECT[t].NodeConstructor).treat(e),
    ...
    Interpreter.prototype.isKismetMathNode = function() {
        ...
        return null !== r && (-1 !== (t = searchPropWithName(r.value, "MacroGraph")).value.indexOf("StandardMacros:Increment") || -1 !== t.value.indexOf("StandardMacros:Decrement")) || null !== (r = searchPropWithName(this.currentNode.props, "FunctionReference")) && (null === (e = searchPropWithName(r.value, "MemberParent")) && (e = searchPropWithName(r.value, "MemberParentClass")),
        t = searchPropWithName(r.value, "MemberName"),
        null !== e && null !== t && (-1 !== e.value.indexOf("KismetMathLibrary") && !1 !== getKismetMathText(t.value)))
    }
    ,
    Interpreter.prototype.isDotNode = function() {
        ...
        return null !== r && (e = searchPropWithName(r.value, "MemberParent"),
        t = searchPropWithName(r.value, "MemberName"),
        null !== e && null !== t && !(-1 === t.value.indexOf("Dot_VectorVector") && -1 === t.value.indexOf("DotProduct2D") || -1 === e.value.indexOf("KismetMathLibrary") && -1 === e.value.indexOf("KismetStringLibrary")))
    }
    ,
    ...
    UNode.prototype.treat = function(e) {
        ...
        else if (t = convertTextToProps(e),
        Array.isArray(t))
    ...
    UNode.prototype.generateTextProps = function(e) {
        ...
        this.isBelow413Version) {
            ...
            for (; i < r; ++i)
                ...
                this.isBelow52Version || (t = h.indexOf("="),
                -1 !== (n = h.indexOf("(")) && n < t ? f = n : -1 !== t && (f = t),
    ...
    UNode.prototype.generateCssNodeStyle = function() {
        var e = [];
        return e.push("position:absolute"),
        e.push("transform: translate(" + this.position[0] + "px, " + this.position[1] + "px)"),
    ...
    UNode.prototype.findCssClassNodeIcon = function() {
        ...
        if (null !== (n = searchPropWithName(this.objectDefinition, "Class")))
            for (r = 0,
            o = EQUIVALENCE_MAP_BLUEPRINT_CLASS_TO_CSS_ICON.length; r < o; ++r)
        ...
        if (null !== (e = searchPropWithName(this.props, "FunctionReference"))) {
            if (s = null !== (s = searchPropWithName(e.value, "MemberParent")) && -1 !== s.value.indexOf("KismetMathLibrary"),
        ...
        return null !== (e = searchPropWithName(this.props, "bIsPureFunc")) && "True" === e.value ? (s = this.findHeaderName(),
        -1 !== ["Break Hit Result"].indexOf(s) ? "break-struct" : "pure-function-call") : "function-call"
    }
    ,
    UNode.prototype.findIconAfterNode = function() {
        for (var e, t = searchPropWithName(this.objectDefinition, "Class"), n = ["K2Node_LatentOnlineCall", "K2Node_LatentGameplayTaskCall", "K2Node_AsyncAction", "K2Node_AIMoveTo", "K2Node_LatentOnlineCall", "K2Node_PlayMontage"], s = 0, i = n.length; s < i; ++s)
    ...
    UNode.prototype.findHeaderName = function() {
        var e, t = -1, n = "", s = null, i = null, r = null, o = null, a = null, l = !1, u = !1, c = !1, d = !1, p = null, h = null, f = null, N = null, m = 0, C = this.pins.length, g = null, v = null, S = null, b = null, _ = "", O = "", P = searchPropWithName(this.objectDefinition, "Class");
        ...
        if (-1 !== P.value.indexOf("K2Node_DynamicCast"))
            return null !== (h = searchPropWithName(this.props, "TargetType")) ? (n = h.value,
            "Cast To " + (n = -1 !== (t = h.value.lastIndexOf(".")) ? n.substr(t + 1).replace("'", "") : n).replace('"', "")) : "Bad cast node";
        if (-1 !== P.value.indexOf("K2Node_SpawnActorFromClass")) {
            for (n = "NONE"; m < C; ++m)
                if (f = searchPropWithName(this.pins[m].props, "PinName"),
            ...
            for (m = 0; m < C; ++m)
                ...
                "Class" === f.value) {
                    ...
                    if (-1 !== (t = N.value.lastIndexOf(".")))
                        return n = N.value.substring(t + 1).replace('"', ""),
            ...
            for (m = 0; m < C; ++m)
                ...
                "ReturnValue" === f.value) {
                    ...
                    if (-1 !== (t = v.value.lastIndexOf(".")))
                        return '"' === (n = v.value.substring(t + 1).replace("'", "")).charAt(n.length - 1) && (n = n.substr(0, n.length - 1)),
                        "Create " + transformInternalName(n)
                }
            return "Create Widget"
        }
        if (-1 === P.value.indexOf("K2Node_BreakStruct"))
            return -1 !== P.value.indexOf("K2Node_SetFieldsInStruct") ? (n = "NONE",
            "Set members in " + (n = null !== (S = searchPropWithName(this.props, "StructType")) && -1 !== (t = (n = S.value).lastIndexOf(".")) ? n.substr(t += 1).replace("'", "") : n)) : -1 !== P.value.indexOf("K2Node_AsyncAction") && null !== (i = searchPropWithName(this.props, "ProxyFactoryFunctionName")) ? "Async Task: " + i.value : -1 !== (b = "K2Node_" === (b = P.value).substr(0, 7) ? b.substr(7) : b).indexOf("K2Node_MakeArray") ? "Make Array" : -1 !== b.indexOf("K2Node_MakeStruct") ? (n = "NONE",
            "Make Struct " + (n = null !== (S = searchPropWithName(this.props, "StructType")) && -1 !== (t = (n = S.value).lastIndexOf(".")) ? (n = n.substring(t + 1)).lastIndexOf("\"'") + 2 === n.length ? n.substring(0, n.length - 2) : n.substring(0, n.length - 1) : n)) : transformInternalName(b);
        for (m = 0; m < C; ++m)
    ...
    UNode.prototype.generateHTMLPinDelegate = function() {
        for (var e = [], t = 0, n = this.pins.length; t < n; ++t)
            this.pins[t].isDelegateOutput() && e.push(this.pins[t].generateHTML(!0, this));
        return e
    }
    ,
    ...
    UNode.prototype.generateHTMLPinsOutput = function() {
        for (var e = [], t = this.isAdvancedPinDisplayExpanded(), n = 0, s = this.pins.length; n < s; ++n)
            this.pins[n].isOutput() && !1 === this.pins[n].isDelegateOutput() && e.push(this.pins[n].generateHTML(t, this));
        return e
    }
    ,
    ...
    UNode.prototype.callbackInspectNode = function(e, t) {
        ...
        if (!1 !== this.containsVisualNodes && 0 !== this.nodes.length)
            if (1 === this.nodes.length)
                for (this.nodes[0].containsVisualNodes = !0,
                this.nodes[0].objectDefinition = t,
                s = this.nodes[0].nodes.length; n < s; ++n)
                ...
                for (0 < (s = this.nodes[1].nodes.length) && !1 === this.nodes[1].containsVisualNodes && (this.nodes[1].containsVisualNodes = !0,
                this.nodes[1].objectDefinition = this.nodes[0].objectDefinition); n < s; ++n)
    ...
    BasicObject.prototype.treat = function(t) {
        ...
        else if (this.isBelow52Version || '"' !== t.substring(0, 1) || (t = t.replace('"', "").replace('"', "")),
    ...
    BasicObject.prototype.generateTextProps = function() {
        for (var t, e, i = [], n = 0, o = this.props.length, s = "", r = "", c = -1; n < o; ++n)
            ...
            this.isBelow52Version || (t = r.indexOf("="),
            -1 !== (e = r.indexOf("(")) && e < t ? c = e : -1 !== t && (c = t),
    ...
    (NAnimStateTransition.prototype.constructor = NAnimStateTransition).prototype.generateHTML = function() {
        return this.pins[0].props.bHidden = !1,
    ...
    NArray.prototype.generateHTMLBody = function() {
        var t = []
          ...
          , i = ""
          , s = 130;
        return null === r ? null !== e && -1 !== e.value.indexOf("K2Node_GetArrayItem") && (i = "GET") : null !== (e = searchPropWithName(r.value, "MemberName")) && (i = getArrayText(e.value)),
        "LastIndex" === i && (i = "",
        t = [{
            text: "Last"
        }, {
        ...
        s = 185),
        "RemoveItem" === i && (i = "Remove",
        s = 185),
        "Length" === i ? s = 180 : "AddUnique" === i ? s = 225 : "Append" === i ? s = 180 : "Clear" === i ? s = 150 : "Contains" === i ? s = 200 : "Shuffle" === i ? s = 180 : "Resize" === i && (s = 150),
        {
            tag: "div",
            classes: ["body"],
            attrs: [{
    ...
    NArray.prototype.findCssClassArray = function() {
        for (var t, e = null, r = null, i = null, s = "", a = 0, n = this.pins.length; a < n; ++a)
            this.pins[a].isInput() && null !== (t = searchPropWithName(this.pins[a].props, "PinName")) && ("TargetArray" === t.value && "struct" === (e = this.pins[a].getPropFromPinType("PinCategory").value) && (i = this.pins[a].getPropFromPinType("PinSubCategoryObject")),
            "Array" === t.value && "struct" === (r = this.pins[a].getPropFromPinType("PinCategory").value) && (i = this.pins[a].getPropFromPinType("PinSubCategoryObject")));
        return null !== e ? s = e : null !== r && (s = r),
        "struct" === s && null !== i && ("/Script/CoreUObject.ScriptStruct'" === i.value.substring(0, 33) && (i.value = i.value.substring(20)),
        "ScriptStruct'/Script/CoreUObject.Vector'" === i.value || "ScriptStruct'\"/Script/CoreUObject.Vector\"'" === i.value || "ScriptStruct'/Script/CoreUObject.Vector3f'" === i.value || "ScriptStruct'\"/Script/CoreUObject.Vector3f\"'" === i.value ? s = "vector" : "ScriptStruct'/Script/CoreUObject.Rotator'" === i.value || "ScriptStruct'\"/Script/CoreUObject.Rotator\"'" === i.value ? s = "rotator" : "ScriptStruct'/Script/CoreUObject.Transform'" !== i.value && "ScriptStruct'\"/Script/CoreUObject.Transform\"'" !== i.value || (s = "transform")),
        s
    }
    ;
    function NComment() {
    ...
    NComment.prototype.generateCssNodeStyle = function() {
        ...
        return e.push(this.addBodyStyleColor()),
        e
    }
    ,
    ...
    NComment.prototype.getColorComment = function() {
        ...
        return null !== t && e.setValuesFromProps(t.value),
        e
    }
    ,
    NComment.prototype.addBodyStyleColor = function() {
        ...
        return e.alpha = .1,
        "background-color:" + e.generateCss()
    }
    ,
    ...
    function getTextDeclarationForUnreal(e, t) {
        for (var n, o, i = "", r = getIndentFormat(t), s = 0, a = e.length, d = 0; s < a; ++s) {
            if (i += r + "Begin " + e[s].generateTextObjectDefinition(),
            0 < e[s].nodes.length && (i += getTextDeclarationForUnreal(e[s].nodes, t + 1)),
            e[s].isBelow413Version)
                for (n = getIndentFormat(t + 1),
                d = 0,
                o = e[s].pins.length; d < o; ++d)
    ...
    NEvent.prototype.findHeaderName = function() {
        var e, t, n, r = "Event", o = ["FunctionReference", "EventReference", "EventSignatureName"], a = 0, i = o.length, u = "", l = searchPropWithName(this.objectDefinition, "Class"), p = null;
        if (null !== l && (-1 !== l.value.indexOf("K2Node_ComponentBoundEvent") || -1 !== l.value.indexOf("K2Node_ActorBoundEvent"))) {
            if (u = null === (e = searchPropWithName(this.props, "ComponentPropertyName")) ? "None" : e.value,
            e = searchPropWithName(this.props, "DelegatePropertyName"),
            null !== (t = searchPropWithName(this.props, "DelegatePropertyDisplayName")))
        ...
        for (; a < i; ++a)
            if (null !== (n = searchPropWithName(this.props, o[a])))
                return null === (p = searchPropWithName(n.value, "MemberName")) ? n.value : -1 !== p.value.indexOf("Receive") ? r + " " + p.value.substring(7) : r + " " + p.value;
        return r
    }
    ;
    ...
    NInputKey.prototype.findHeaderName = function() {
        ...
        return e = void 0 === propsConvertion[e] ? transformInternalName(e) : propsConvertion[e],
        e = null !== u && -1 !== u.value.indexOf("K2Node_InputDebugKey") ? "Debug Key " + e : e
    }
    ,
    ...
    NKismetMath.prototype.generateHTMLBody = function() {
        var e = ""
          ...
          , s = null;
        return null !== a && -1 !== a.value.indexOf("K2Node_EnumEquality") ? e = "==" : null !== a && -1 !== a.value.indexOf("K2Node_EnumInequality") ? e = "!=" : null === t ? (a = searchPropWithName(this.props, "FunctionReference"),
        a = searchPropWithName(a.value, "MemberName"),
        e = getKismetMathText(a.value)) : -1 !== (s = searchPropWithName(t.value, "MacroGraph")).value.indexOf("StandardMacros:Increment") ? e = "++" : -1 !== s.value.indexOf("StandardMacros:Decrement") && (e = "--"),
        {
            tag: "div",
            classes: ["body"],
            childs: [{
    ...
    NKnot.prototype.generateHTMLPinsInput = function() {
        for (var t = [], e = this.isAdvancedPinDisplayExpanded(), n = 0, s = this.pins.length; n < s; ++n)
            this.pins[n].isInput() && (this.pins[n].disableTextAndInput(),
    ...
    NKnot.prototype.generateHTMLPinsOutput = function() {
        for (var t = [], e = this.isAdvancedPinDisplayExpanded(), n = 0, s = this.pins.length; n < s; ++n)
            this.pins[n].isOutput() && (this.pins[n].disableTextAndInput(),
            t.push(this.pins[n].generateHTML(e, this)));
        return t
    }
    ;
    ...
    NMaterialGraphNode.prototype.getMaterialName = function() {
        var e, n, t = "", a = -1, i = "Lerp", r = ["0", "1", "0.5"], l = null, o = 0, s = null, u = null, p = null, d = null, h = searchPropWithName(this.nodes[0].objectDefinition, "Class"), c = null, f = null, v = null;
        if (null === h)
            return "";
        if (-1 !== h.value.indexOf("MaterialExpressionMaterialFunctionCall")) {
            ...
            if (-1 !== h.value.indexOf("MaterialExpressionLinearInterpolate"))
                return this.pins[0].isLinkedTo() && (r[0] = ""),
            ...
            if (-1 !== h.value.indexOf("MaterialExpressionConstant")) {
                if (null === (l = searchPropWithName(this.nodes[1].props, "Constant")))
                    return f = searchPropWithName(this.nodes[1].props, "R"),
                    v = searchPropWithName(this.nodes[1].props, "G"),
                    null !== f && null !== v ? f.value.replace(/(\.\d+?)0+\b/, "$1") + "," + v.value.replace(/(\.\d+?)0+\b/, "$1") : null !== f ? f.value.replace(/(\.\d+?)0+\b/, "$1") : "0";
    ...
    (NMetasound.prototype.constructor = NMetasound).prototype.findHeaderName = function() {
        ...
        if (null !== l)
            return null !== t && "False" === t.value ? "MetaSoundSource" : (t = searchPropWithName(l.value, "Namespace"),
            e = searchPropWithName(l.value, "Name"),
            l = searchPropWithName(l.value, "Variant"),
            null !== t && -1 !== ["Array", "Print Log", "AD Envelope", "ADSR Envelope", "Crossfade", "MapRange", "Clamp", "Max", "Min", "TriggerCompare", "TriggerRoute"].indexOf(t.value) ? "Crossfade" === t.value ? "Crossfade " + e.value.substring(13) : "TriggerRoute" === t.value ? e.value : (a = e.value,
            "Concat" === e.value && (a = "Concatenate"),
            "MapRange" === t.value && (a = "Map Range"),
            (a = "TriggerCompare" === t.value ? "Trigger Compare" : a) + " (" + l.value + ")") : "Wave Player" === e.value ? "5dot1" === l.value ? "Wave Player (5.1)" : "7dot1" === l.value ? "Wave Player (7.1)" : "Wave Player (" + l.value + ")" : "WaveWriter" === (t = e.value.substring(0, 10)) ? "Wave Writer (Mono)" : "Band Split" === t ? e.value.substring(e.value.indexOf("(") + 1, e.value.indexOf(",")) + " Band Splitter (" + e.value.substring(e.value.length - 2, e.value.length - 1) + ")" : "Audio Mixe" === t ? e.value.substring(e.value.indexOf("(") + 1, e.value.indexOf(",")) + " Mixer (" + e.value.substring(e.value.length - 2, e.value.length - 1) + ")" : void 0 !== i[e.value] ? i[e.value] : -1 !== ["MIDI To Frequency", "Trigger On Value Change", "Value"].indexOf(e.value) ? e.value + " (" + l.value + ")" : e.value);
        if (null !== (n = searchPropWithName(this.objectDefinition, "Class"))) {
    ...
    NMetasound.prototype.generateHTML = function() {
        var e, a = {
            ...
            childs: [this.generateHTMLToolTip(), this.generateHTMLHeader()]
        }, n = null, l = 0, t = searchPropWithName(this.props, "ClassName"), i = !1;
        if (null === t || null === (t = searchPropWithName(t.value, "Namespace")) || "VariableMutator" !== t.value && "VariableAccessor" !== t.value && "VariableDeferredAccessor" !== t.value || (i = !0,
        a.classes.push("variable")),
        ...
        Array.isArray(n))
            ...
            a.childs.push(n);
        return "" !== (t = this.getIconCenterClass()) && (a.classes.push("icon-center"),
        a.classes.push(t)),
        a
    }
    ,
        ...
        if (null !== e) {
            ...
            if (null !== (n = searchPropWithName(e.value, "Name"))) {
                if ("conversion" === n.value.toLowerCase().substring(0, 10))
                    return "conv";
                if (-1 !== ["add", "divide", "logarithm", "modulo", "multiply", "power", "subtract"].indexOf(n.value.toLowerCase()))
    ...
    NMetasound.prototype.generateHTMLBody = function() {
        ...
        return "input" === e && (a[0].childs = [a[0].childs[1]]),
        "output" === e && (a[0].childs = [a[0].childs[0]]),
        this.hasAdvancedPinDisplay() && (this.isAdvancedPinDisplayExpanded() ? a.push({
            tag: "div",
            classes: ["less"],
            childs: [{
                tag: "span"
    ...
    NMetasound.prototype.detectInputSelectToCreate = function() {
        ...
        if (null !== t) {
            ...
            if (i = searchPropWithName(t.value, "Namespace"),
            ...
            void 0 !== e[a.value])
                ...
                if ("Convert" === i.value && null !== n && "Enum:" === n.value.substring(0, 5))
                    return l = n.value.substring(5).replace(" ", "").split(/(?=[A-Z])/).join("_").toUpperCase(),
                    void this.setInputSelectValuesToPin(l, n.value);
                if ("VariableMutator" === i.value && "Enum:" === a.value.substring(0, 5))
                    return l = a.value.substring(5).replace(" ", "").split(/(?=[A-Z])/).join("_").toUpperCase(),
                ...
                if ("TriggerCompare" === i.value)
                    ...
                    if ("Band Splitter" !== a.value.substring(0, 13))
                        return "DynamicFilter" === a.value ? (this.setInputSelectValuesToPin("DYNAMIC_FILTER_TYPE", "FilterType"),
                        void this.setInputSelectValuesToPin("ENVELOPE_PEAK_MODE", "EnvelopeMode")) : void ("WaveTableEnvelope" === a.value && (this.setInputSelectValuesToPin("WAVE_TABLE_ENVELOPE_MODE", "Mode"),
                        this.setInputSelectValuesToPin("WAVE_TABLE_INTERPOLATION", "Interpolation")));
    ...
    (NNiagara.prototype.constructor = NNiagara).prototype.generateHTML = function() {
        var e, a = null;
        return this.detectInputSelectToCreate(),
        a = UNode.prototype.generateHTML.call(this),
        null !== (e = searchPropWithName(this.props, "CustomHlsl")) && a.childs.push({
            tag: "div",
            classes: ["bottom"],
            childs: [{
                tag: "div",
    ...
    NNiagara.prototype.findCssClassNodeColor = function() {
        ...
        if (null !== e) {
            ...
            if (-1 !== e.value.indexOf("NiagaraNodeInput"))
                return searchPropWithName(this.props, "Usage"),
                "event";
    ...
    NNiagara.prototype.detectInputSelectToCreate = function() {
        for (var e, a, n = 0, t = this.pins.length, r = null, l = ""; n < t; ++n)
            null === (a = this.pins[n].getPropFromPinType("PinCategory")) || "Enum" !== a.value && "StaticEnum" !== a.value || null !== (r = this.pins[n].getPropFromPinType("PinSubCategoryObject")) && (a = r.value.substr(r.value.lastIndexOf(".") + 1).replace('"', "").replace("'", ""),
            void 0 !== ENUM_NIAGARA[a] && (l = "",
            null !== (e = searchPropWithName(this.pins[n].props, "DefaultValue")) && (l = e.value),
    ...
    (NPCG.prototype.constructor = NPCG).prototype.generateHTML = function() {
        var e, t, n = 0, o = this.pins.length, r = null, a = 0, i = searchPropWithName(this.objectDefinition, "Class"), s = ["node", "npcg"];
        for (null !== i && -1 !== i.value.indexOf("PCGEditorGraphNodeReroute") && (this.isKnot = !0,
        s.push("knot")); n < o; ++n)
    ...
    NPCG.prototype.generateCssNodeHeader = function() {
        var e, t = null, n = this.nodes[0].objectDefinition[2].value, o = ["Modifier", "CreateSpline", "Difference", "Distance", "Data", "Gather", "Projection", "NormalToDensity", "TransformPoints", "Bounds", "Union", "Merge", "Intersection", "Debug", "ToPoint", "Query"], r = 0, a = o.length;
    ...
    NPCG.prototype.findHeaderName = function() {
        ...
        if ("ExecuteBlueprint_" === a.substring(0, 17)) {
            if (a = "Execute Blueprint",
            this.nodes[0] && this.nodes[0].nodes[1] && this.nodes[0].nodes[1].nodes[0] && this.nodes[0].nodes[1].nodes[0].objectDefinition[1]) {
        ...
        if ("Subgraph" !== (a = -1 !== (e = a.indexOf("_")) ? a.substring(0, e) : a))
            return "FilterByTag" === a && (null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "Operation")) && "RemoveTagged" === o.value ? a += "(Remove)" : a += "(Keep)",
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "SelectedTags")) && (a += ": " + o.value)),
            "AddAttribute" === a || "CreateAttribute" === a ? (a = "None: 0.00",
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "OutputAttributeName")) && (a = o.value),
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "AttributeTypes")) ? a + ": " + this.getAttributeValue(o) : a + ": 0.00") : ("FilterAttribute" === a && (null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "Operation")) && "DeleteSelectedAttributes" === o.value ? a += "(Delete)" : a += "(Keep)",
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "SelectedAttributes")) && (a += ": " + o.value)),
            "AttributeBitwiseOp" === a ? this.getOperationName("Bitwise", "And") : "AttributeBooleanOp" === a ? this.getOperationName("Boolean", "And") : "AttributeCompareOp" === a ? this.getOperationName("Compare", "Equal") : "AttributeMathsOp" === a ? this.getOperationName("Maths", "Add") : "AttributeRotatorOp" === a ? this.getOperationName("Rotator", "Combine") : "AttributeTransformOp" === a ? this.getOperationName("Transform", "Compose") : "AttributeTrigOp" === a ? this.getOperationName("Trig", "Acos") : "AttributeVectorOp" === a ? this.getOperationName("Vector", "Cross") : "AttributeReduce" === a ? (a = "Reduce LastAttribute",
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "OutputAttributeName")) && (a += " to " + o.value),
            this.getOperationName(a, "Average")) : "AttributeSelect" === a ? (a = this.getOperationName("Select LastAttribute", "Min"),
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "Axis")) ? "CustomAxis" === o.value ? null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "CustomAxis")) ? a + " on (" + formatAxisValueForDisplay(o.value[0].value) + ", " + formatAxisValueForDisplay(o.value[1].value) + ", " + formatAxisValueForDisplay(o.value[2].value) + ", " + formatAxisValueForDisplay(o.value[3].value) + ")" : a + " on (0.00, 0.00, 0.00, 0.00)" : a + " on " + o.value : a + " on X") : ("TransferAttribute" === a && (a += null === (o = searchPropWithName(this.nodes[1].nodes[1].props, "SourceAttributeName")) ? " None" : " " + o.value,
            null !== (o = searchPropWithName(this.nodes[1].nodes[1].props, "TargetAttributeName")) && (a += " to " + o.value)),
            "DataTableRowToAttributeSet" === a && (a = null === (o = searchPropWithName(this.nodes[1].nodes[1].props, "DataTable")) ? " None" : -1 === (r = o.value.lastIndexOf(".")) ? " " + o.value : " " + o.value.substring(r + 1),
            a += null === (o = searchPropWithName(this.nodes[1].nodes[1].props, "RowName")) ? "[ None ]" : "[ " + o.value + " ]"),
            a));
        for (i = 0,
        t = this.nodes[1].nodes.length; i < t; ++i)
    ...
    NPCG.prototype.overrideConnectorTypeForPins = function() {
        for (var e, t, n, o, r = 0, a = this.pins.length, i = null, s = null, l = 0, u = !1, p = -1, d = "connector", c = "exec", h = 0, g = 0, f = "", m = !0, v = !0, N = []; r < a; ++r)
            if (e = this.pins[r].getPropFromPinType("PinCategory"),
            ...
            this.isKnot)
            ...
            else if (null === (s = searchPropWithName(this.pins[r].props, "PinName")))
                this.pins[r].override.connectorType = {
                    connector: "connector",
                    type: "exec"
                };
                ...
                for (u = !1,
                l = 0,
                t = this.nodes[1].nodes.length; l < t; ++l)
                    if (0 !== this.nodes[1].nodes[l].props.length) {
                        for (p = -1,
                        h = 0,
                        n = this.nodes[1].nodes[l].props.length; h < n; ++h)
                        ...
                        if (-1 !== p) {
                            for (v = m = !(f = ""),
                            g = 0,
                            o = (N = this.nodes[1].nodes[l].props[p].value).length; g < o; ++g)
                                "Label" === N[g].name && (f = N[g].value.toLowerCase()),
                                "bAllowMultipleData" === N[g].name && "False" === N[g].value && (m = !1),
                                "bAllowMultipleConnections" === N[g].name && "False" === N[g].value && (v = !1);
                            if (f === s.value.toLowerCase()) {
                                ...
                                (c = "exec") === (c = "" !== i.value ? "pcg-" + i.value.toLowerCase().replaceAll(" ", "-") : c) && (c = "pcg-any-data",
                                null !== e && "Concrete Data" === e.value && "" === i.value && (c = "pcg-concrete-data")),
                                this.pins[r].override.connectorType = {
                                    connector: d,
                                    type: c
                                },
        ...
        -1 !== (i = i.value.lastIndexOf("."))))
            if ("DataDrivenCVarEngineSubsystem" === (s = s.substr(i + 1).replace("'", "")))
                ...
                for (e = (t = s.match(/[A-Z]?[a-z]+|[0-9]+|[A-Z]+(?![a-z])/g)).length; a < e; ++a)
                    ...
                    l += t[a].length,
                    "HLOD" !== t[a] && "ISM" !== t[a] && "PCG" !== t[a] && a + 1 < e && (l + t[a + 1].length < 11 ? (n.push({
                        text: " "
                    }),
                    l += t[a + 1].length) : (n.push({
                        tag: "br"
                    }),
                    l = 0));
        return {
    ...
    (NVariableSet.prototype.constructor = NVariableSet).prototype.generateHTML = function() {
        ...
        {
            tag: "div",
            classes: ["node", "nvariableset", (e = this.getVariableType()).connector, e.type],
            attrs: [{
                name: "style",
                value: this.generateCssNodeStyle().join(";")
            }, {
    ...
    NVariableSet.prototype.generateHTMLBody = function() {
        ...
        return {
            ...
            childs: [{
                tag: "div",
                classes: ["round-bg-color", e.connector, e.type]
            }, {
                tag: "div",
                classes: ["round-bg"],
                text: "SET"
    ...
    NVariableSet.prototype.getVariableType = function() {
        for (var e = 0, t = this.pins.length; e < t; ++e)
            if (this.pins[e].isOutput() && !1 === this.pins[e].isDelegateOutput() && "exec" !== this.pins[e].getPropFromPinType("PinCategory").value)
                return this.pins[e].getConnectorType();
        return {
            connector: "connector",
            type: "object"
    ...
    Pin.prototype.getLinks = function() {
        ...
        else if (null !== (t = searchPropWithName(this.props, "LinkedTo")) && Array.isArray(t.value))
    ...
    Pin.prototype.generateTextForUnreal = function(t) {
        ...
        if (this.isBelow413Version) {
            for (e = getIndentFormat(t + 1),
            a.push(r + 'Begin Object Name="' + this.id + '"'); s < i; ++s)
    ...
    Pin.prototype.generateHTML = function(t, e) {
        var a, r = "", s = {}, i = "", n = "", l = null, u = ["label-text"], o = null, c = [], p = null, h = null, v = null, g = "", f = "", x = null, d = null, m = [], S = 0, b = null;
        if (this.isHidden())
            return null;
        if (this.hasToHidePin(t) && (r = "hidden"),
        ...
        this.isDelegateOutput())
            l = {
                ...
                childs: ["NDelegate" === e.constructor.name && {
                    tag: "div",
                    classes: [u],
                    text: "Event"
                }, {
                    tag: "div",
                    classes: ["clink", s.connector, s.type, i]
                }]
            };
        else if (this.isInput())
            if (null !== (o = this.getPropFromPinType("PinSubCategory")) && "DynamicAddPin" === o.value && (this.hasToGenerateInput = !1,
            u.push("icon-plus")),
            null !== (e = this.getPropFromPinType("PinCategory")) && "WaveTable" === e.value && (this.hasToGenerateInput = !1),
            c = [],
            "connector-map" === s.connector && (v = this.getPropFromPinType("PinValueType"),
            p = searchPropWithName(v.value, "TerminalSubCategoryObject"),
            h = v.value[0].value,
            null !== p && ("/Script/CoreUObject.ScriptStruct'" === p.value.substring(0, 33) && (p.value = p.value.substring(20)),
            "ScriptStruct'/Script/CoreUObject.Vector'" === p.value || "ScriptStruct'\"/Script/CoreUObject.Vector\"'" === p.value || "ScriptStruct'/Script/CoreUObject.Vector3f'" === p.value || "ScriptStruct'\"/Script/CoreUObject.Vector3f\"'" === p.value ? h = "vector" : "ScriptStruct'/Script/CoreUObject.Rotator'" === p.value || "ScriptStruct'\"/Script/CoreUObject.Rotator\"'" === p.value ? h = "rotator" : "ScriptStruct'/Script/CoreUObject.Transform'" !== p.value && "ScriptStruct'\"/Script/CoreUObject.Transform\"'" !== p.value || (h = "transform")),
            c = [{
                tag: "div",
                classes: ["key", s.type]
            }, {
            ...
            "connector-map" !== s.connector && "transform" !== s.type || (m = []),
            e = this.findText(),
            l = {
                tag: "div",
                classes: ["pin", r],
            ...
            this.hasInputSelect())
                "" !== e && (l.childs[0].childs[1].classes.push("space-input-select"),
                l.childs[0].childs.push({
                    tag: "br"
                })),
            ...
            null !== (o = this.getPropFromPinType("PinSubCategory")) && "DynamicAddPin" === o.value && (this.hasToGenerateInput = !1,
            u.push("icon-plus")),
            b = null,
    ...
    Pin.prototype.getConnectorType = function() {
        ...
        return null !== this.override.connectorType ? this.override.connectorType : (r = this.getPropFromPinType("PinCategory"),
        ...
        -1 !== ["exec"].indexOf(i = r) ? a = "connector-image" : null !== t && "True" === t.value ? a = "connector-array" : null !== e && "Set" === e.value ? a = "connector-set" : null !== e && "Map" === e.value ? a = "connector-map" : null !== e && "Array" === e.value ? a = "connector-array" : "trigger" === i && (a = "connector-trigger"),
        "statictype" === i && null !== s && (-1 !== s.value.indexOf("Niagara.NiagaraInt32") ? i += "-int" : -1 !== s.value.indexOf("Niagara.NiagaraBool") && (i += "-bool")),
        "struct" === r ? (null !== s && ("/Script/CoreUObject.ScriptStruct'" === s.value.substring(0, 33) && (s.value = s.value.substring(20)),
    ...
    Pin.prototype.findText = function() {
        var t, e, a = "", r = null;
        if (!1 === this.hasToGenerateText)
            return a;
        if (null !== (t = this.getPropFromPinType("PinSubCategory")) && "DynamicAddPin" === t.value)
            return a;
        if (r = this.getPropFromPinType("PinCategory"),
        t = searchPropWithName(this.props, "PinFriendlyName"),
        null !== (e = searchPropWithName(this.props, "PinName")) && null === t && ("then" === e.value || "execute" === e.value || "exec" === e.value))
            return a;
        if (null === r)
        ...
        if (null !== t)
            ...
            if ("audio" === t && "UE.OutputFormat.Mono.Audio:0" === e.value)
                return "Out Mono";
            "then" !== e.value && "execute" !== e.value && (a = e.value,
    ...
    Pin.prototype.generateHTMLInput = function() {
        var t, e = [], a = null, r = null, s = null, i = "", n = ["exec", "delegate", "trigger", "audio"], l = "Asset", u = "", o = [], c = [], p = 0, h = 0;
        if (!1 === this.hasToGenerateInput)
            return e;
        if (this.isLinkedTo())
            return e;
        if (r = this.getPropFromPinType("PinCategory"),
        t = this.getPropFromPinType("PinSubCategory"),
        null !== (s = this.getPropFromPinType("PinSubCategoryObject")) && "/Script/CoreUObject.ScriptStruct'" === s.value.substring(0, 33) && (s.value = s.value.substring(20)),
        i = "",
        ...
        if (null !== (n = this.getPropFromPinType("ContainerType")) && "Array" === n.value)
            ...
            e = !1 === this.hasValue() && !1 === this.hasObject() ? [{
                tag: "span",
                classes: ["no-input"]
            }] : null !== t && "self" === t.value ? [{
                tag: "span",
            ...
            if (null !== s)
                ...
                else if (-1 !== s.value.indexOf("Vector3f") || -1 !== s.value.indexOf("NiagaraPosition"))
                    "" === (a = this.getValue()) && (a = "0.0,0.0,0.0"),
                ...
                else if (-1 === s.value.indexOf("Quat4f") && -1 === s.value.indexOf("Niagara.NiagaraMatrix"))
                    if (u = this.getValue(),
                    -1 === (u = -1 === s.value.indexOf("Niagara.NiagaraInt32") && -1 === s.value.indexOf("Niagara.NiagaraFloat") ? u : u.replace(/(\.\d+?)0+\b/, "$1")).indexOf("<br>"))
                        e = [{
                            tag: "span",
                            classes: ["fake-input", i],
                            attrs: [{
        ...
        } else if (u = this.getValue(),
        "" === (u = "float" !== r && "double" !== r && "real" !== r && "time" !== r && "int32" !== r ? u : u.replace(/(\.\d+?)0+\b/, "$1")) && ("int32" === r || "int" === r ? u = "0" : "float" !== r && "double" !== r && "real" !== r && "time" !== r || (u = "0.0")),
        -1 === u.indexOf("<br>"))
            e = [{
                tag: "span",
                classes: ["fake-input", i],
    ...
    Pin.prototype.convertColorToRgbaCssFromValue = function() {
        ...
        return 0 < a.length ? (a = (r = a.split(","))[0].substr(3),
        t = r[1].substr(2),
        e = r[2].substr(2),
        r = r[3].substr(2, r[3].length - 3),
        "rgba(" + float2dec(a) + "," + float2dec(t) + "," + float2dec(e) + "," + r + ")") : "rgba(0,0,0,1)"
    }
    ,
    ...
    Pin.prototype.hasToHidePin = function(t) {
        var e;
        return !t && (t = searchPropWithName(this.props, "bAdvancedView"),
    ...
    function Updater(t, e) {
        return "object" != typeof t ? new TypeError("Argument 'options' is incorrect, expect object, get " + typeof t) : e instanceof Bus ? (this.data = {
            options: t
        },
        void (this.bus = e)) : new TypeError("Bus argument must be instance of Bus")
    }
    ...
    function isIE() {
        ...
        return t.innerHTML = "\x3c!--[if lte IE 7]>1<![endif]--\x3e",
        "1" === t.innerHTML || (-1 !== window.navigator.userAgent.toUpperCase().indexOf("TRIDENT") || -1 !== window.navigator.userAgent.toUpperCase().indexOf("MSIE"))
    }
    ...
    Environment.prototype.createPlayground = function(t) {
        var e = []
          , o = "CREATE PLAYGROUND...";
        return this.options.height && e.push("height:" + this.options.height),
        isIE() && (o = "This website stop supporting Internet Explorer from version 5.5 to 11, consequently you have to use a modern browser."),
        e = createElems([{
            tag: "div",
            classes: ["bue-render"],
            childs: [{
                ...
                childs: [{
                    ...
                    childs: [{
                        ...
                        childs: [{
                            tag: "div",
                            classes: ["frame-header__buttons-panel", "hidden" /* CHANGED */]
                        }, {
                            tag: "div",
                            classes: ["frame-header__buttons-separator", "hidden" /* CHANGED */]
                        }, {
                            tag: "div",
                            classes: ["frame-header__buttons-fullscreen", "hidden" /* CHANGED */],
                            text: "Fullscreen"
                        }, {
                            tag: "div",
    ...
    Environment.prototype.displayNodesInViewport = function(e) {
        for (var t, o = document.createDocumentFragment(), s = 0, n = e.length; s < n; ++s)
            try {
                ...
                throw e[s].guid ? (t.message = "NodeGUID " + e[s].guid + ": " + t.message,
                t.NodeGUID = e[s].guid) : (t.message = "Node #" + s + ": " + t.message,
                t.NodeIdx = s),
                t
            }
    ...
    Environment.prototype.computeSVGLink = function(t, e, o) {
        var s = null
          ...
          , p = this.dom.canvas.offsetLeft
          , u = c.top + window.scrollY
        ...
        l.left -= p + c,
        d = correctionWidth(t),
        u = correctionHeight(t),
        p = Math.min(a.left, l.left) + d,
        c = Math.min(a.top, l.top) + u,
        0 === (i = Math.max(a.left, l.left) - Math.min(a.left, l.left) >> 0) && (i = 2),
        0 === (r = Math.max(a.top, l.top) - Math.min(a.top, l.top) >> 0) && (r = 2),
        d = getSvgPath(a, l, i, r),
        d = correctSvgPathForKnot(d, t, e, a, l, i, r),
        (s = document.createElementNS("http://www.w3.org/2000/svg", "svg")).classList.add("link"),
        s.setAttribute("data-id", o),
        s.setAttribute("style", "transform: translate(" + p + "px, " + c + "px)"),
        s.setAttribute("width", i),
        s.setAttribute("height", r),
        s.setAttribute("pointer-events", "none"),
        s.setAttribute("position", "absolute"),
        (n = document.createElementNS("http://www.w3.org/2000/svg", "path")).setAttribute("d", d),
    ...
    Environment.prototype.reDrawLinks = function(t, e) {
        for (var o, s, n, i, r = 0, a = t.length, l = null, c = null, d = null, p = this.dom.frame.getBoundingClientRect(), u = {}, h = {}, m = 0, g = 0; r < a; ++r)
            ...
            u.top -= s.top + n.top,
            u.left -= s.left + n.left,
            h.top -= s.top + n.top,
            h.left -= s.left + n.left,
            i = correctionWidth(l),
            o = correctionHeight(l),
            s = Math.min(u.left, h.left) + i,
            n = Math.min(u.top, h.top) + o,
            0 === (m = Math.max(u.left, h.left) - Math.min(u.left, h.left)) && (m = 2),
            0 === (g = Math.max(u.top, h.top) - Math.min(u.top, h.top)) && (g = 2),
            i = getSvgPath(u, h, m, g),
            i = correctSvgPathForKnot(i, l, c, u, h, m, g),
            d.querySelector("path").setAttribute("d", i),
            d.setAttribute("style", "transform: translate(" + s + "px, " + n + "px)"),
            d.setAttribute("width", m),
    ...
    Environment.prototype.computeSVGLinkWithMouse = function(t, e, o, s) {
        ...
        s = Math.min(l.left, e.left) + d,
        d = Math.min(l.top, e.top) + c,
        0 === (r = Math.max(l.left, e.left) - Math.min(l.left, e.left) >> 0) && (r = 2),
        0 === (a = Math.max(l.top, e.top) - Math.min(l.top, e.top) >> 0) && (a = 2),
        (n = document.createElementNS("http://www.w3.org/2000/svg", "svg")).classList.add("link", "moving"),
        n.setAttribute("data-id", o),
        n.setAttribute("style", "transform: translate(" + s + "px, " + d + "px)"),
        n.setAttribute("width", r),
        n.setAttribute("height", a),
        n.setAttribute("pointer-events", "none"),
        n.setAttribute("position", "absolute"),
        (i = document.createElementNS("http://www.w3.org/2000/svg", "path")).setAttribute("d", getSvgPath(l, e, r, a)),
        i.setAttribute("transform", ""),
        i.setAttribute("pointer-events", "visibleStroke"),
        i.setAttribute("fill", "none"),
        i.setAttribute("stroke", "#" + getLinkColor(t)),
    ...
    Environment.prototype.stop = function() {
        var t = null;
        for (this.dom.canvas = null,
        this.dom.frame = null,
        this.dom.overlay = null,
        t = this.dom.root.lastElementChild; t; )
